...
customtest(`Validate Order Product`, async ({ page, testDataForOrder }) => {
    //const productNames = page.locator("div.card b");
    const productToOrder = testDataForOrder.productName;
    const userName = testDataForOrder.userName;
    const password = testDataForOrder.password;
    const deliveryAddress = testDataForOrder.deliveryAddress;
